...
The following example, for Ubuntu 18..24.04 LTS, will install the **kitb** toolkit processes to a user created `bin` directory in the user's home directory. It assumes that the Autotools toolchain ('autotools-dev', 'automake' and 'autoconf') have been installed and are accessible to the user. 
...
## Acknowlegement
This toolkit was originally a source base clone of **BioKanga** release 4.4.2 (https://github.com/csiro-crop-informatics/biokanga) which is no longer actively supported by the 'kit4b' author.

**kit4b** is being released under the Opensource Software License Agreement (GPLv3), the same as the original **BioKanga** licencing.
