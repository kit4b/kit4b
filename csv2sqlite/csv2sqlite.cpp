...
struct arg_int *mode = arg_int0("m","mode","<int>",				"Processing mode: 0 parse 'kit4b genmarkers' process generated markers into SQLite database  (default 0)");
...
// show user current resource limits
	...
	{
	printf("\n%s Marker %s, Version %s\n",gszProcName,cpszProcOverview,kit4bversion);
...
struct arg_int *mode = arg_int0("m","mode","<int>",				"Processing mode: 0 parse 'kit4b' process generated SNPs into SQLite database  (default 0)");
struct arg_str *name = arg_str1("n","name","<str>",				"Name by which experiment is identified");
struct arg_str *descr = arg_str0("N","descr","<str>",			"Description of experimental conditions");
struct arg_str *assemb = arg_str1("a","assemb","<str>",			"Cultivar/species used as target assembly when aligning reads");
...
// show user current resource limits
	...
	gDiagnostics.DiagOutMsgOnly(eDLInfo,"rnade transcript CSV file: '%s'",szInFile);
	gDiagnostics.DiagOutMsgOnly(eDLInfo,"SQLite database file: '%s'",szOutFile);
