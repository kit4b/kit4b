...
const int cCSVMaxFields   = 50000000;	// max number of fields in a CSV file which can be processed
const int cCSVDfltFields  = 250;	// default number of fields if SetMaxFields() not called
