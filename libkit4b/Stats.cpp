...
// following implementation of phi() is attributed to https://www.johndcook.com/blog/cpp_phi/
double 
CStats::phi(double x) // one tailed quick and dirty cumulative density function (CDF) of a standard normal (Gaussian) random variable.
{
    // constants
...
double 
CStats::pdfBernoulli(double p, long x)
/* =======================================
...
double 
CStats::cdfBernoulli(double p, long x)
/* =======================================
* NOTE: use 0.0 < p < 1.0 and 0 <= x <= 1 
* =======================================
*/
...
long 
CStats::idfBernoulli(double p, double u)
/* =========================================
...
double 
CStats::pdfEquilikely(long a, long b, long x)
/* ============================================ 
* NOTE: use a <= x <= b 
* ============================================
*/
...
double 
CStats::cdfEquilikely(long a, long b, long x)
/* ============================================
* NOTE: use a <= x <= b 
* ============================================
*/
...
long 
CStats::idfEquilikely(long a, long b, double u)
/* ============================================ 
...
double 
CStats::pdfBinomial(long n, double p, long x)
/* ============================================ 
...
double 
CStats::cdfBinomial(long n, double p, long x)
/* ============================================ 
* NOTE: use 0 <= x <= n and 0.0 < p < 1.0 
* ============================================
*/
...
long 
CStats::idfBinomial(long n, double p, double u)
/* ================================================= 
...
double 
CStats::pdfGeometric(double p, long x)
/* ===================================== 
...
double 
CStats::cdfGeometric(double p, long x)
/* ===================================== 
* NOTE: use 0.0 < p < 1.0 and x >= 0 
* =====================================
*/
...
long 
CStats::idfGeometric(double p, double u)
/* ========================================= 
* NOTE: use 0.0 < p < 1.0 and 0.0 < u < 1.0 
* =========================================
*/
...
double 
CStats::pdfPascal(long n, double p, long x)
/* =========================================== 
...
double 
CStats::cdfPascal(long n, double p, long x)
/* =========================================== 
* NOTE: use n >= 1, 0.0 < p < 1.0, and x >= 0 
* ===========================================
*/
...
long 
CStats::idfPascal(long n, double p, double u)
/* ================================================== 
...
double 
CStats::pdfPoisson(double m, long x)
/* ===================================
...
double 
CStats::cdfPoisson(double m, long x)
/* =================================== 
* NOTE: use m > 0 and x >= 0 
* ===================================
*/
...
long 
CStats::idfPoisson(double m, double u)
/* =================================== 
...
double 
CStats::pdfUniform(double a, double b, double x)
/* =============================================== 
* NOTE: use a < x < b 
* ===============================================
*/
...
double 
CStats::cdfUniform(double a, double b, double x)
/* =============================================== 
* NOTE: use a < x < b 
* ===============================================
*/
...
double 
vidfUniform(double a, double b, double u)
/* =============================================== 
* NOTE: use a < b and 0.0 < u < 1.0 
* ===============================================
*/
...
double 
CStats::pdfExponential(double m, double x)
/* ========================================= 
* NOTE: use m > 0 and x > 0 
* =========================================
*/
...
double 
CStats::cdfExponential(double m, double x)
/* ========================================= 
* NOTE: use m > 0 and x > 0 
* =========================================
*/
...
double 
CStats::idfExponential(double m, double u)
/* ========================================= 
* NOTE: use m > 0 and 0.0 < u < 1.0 
* =========================================
*/
...
double 
CStats::pdfErlang(long n, double b, double x)
/* ============================================ 
...
double 
CStats::cdfErlang(long n, double b, double x)
/* ============================================ 
* NOTE: use n >= 1, b > 0, and x > 0 
* ============================================
*/
...
double 
CStats::idfErlang(long n, double b, double u)
/* ============================================ 
...
double 
CStats::pdfNormal(double m, double s, double x)
/* ============================================== 
...
double 
CStats::cdfNormal(double m, double s, double x)
/* ============================================== 
* NOTE: x and m can be any value, but s > 0.0 
* ==============================================
*/
...
double 
CStats::idfNormal(double m, double s, double u)
/* ======================================================= 
...
double 
CStats::pdfLognormal(double a, double b, double x)
/* =================================================== 
...
double 
CStats::cdfLognormal(double a, double b, double x)
/* =================================================== 
* NOTE: a can have any value, but b > 0.0 and x > 0.0 
* ===================================================
*/
...
double 
CStats::idfLognormal(double a, double b, double u)
/* ========================================================= 
...
double 
CStats::pdfChisquare(long n, double x)
/* ===================================== 
...
double 
CStats::cdfChisquare(long n, double x)
/* ===================================== 
* NOTE: use n >= 1 and x > 0.0 
* =====================================
*/
...
double 
CStats::idfChisquare(long n, double u)
/* ===================================== 
...
double 
CStats::pdfStudent(long n, double x)
/* =================================== 
* NOTE: use n >= 1 and x > 0.0 
* ===================================
*/
...
double 
CStats::cdfStudent(long n, double x)
/* =================================== 
* NOTE: use n >= 1 and x > 0.0 
* ===================================
*/
...
double 
CStats::idfStudent(long n, double u)
/* =================================== 
* NOTE: use n >= 1 and 0.0 < u < 1.0 
* ===================================
*/
...
double 
CStats::LogBeta(double a, double b)
/* ======================================================================
...
double 
CStats::LogChoose(long n, long m)
/* ========================================================================
...
double 
CStats::InGamma(double a, double x)
/* ========================================================================
...
double
CStats::InBeta(double a, double b, double x)
/* ======================================================================= 
