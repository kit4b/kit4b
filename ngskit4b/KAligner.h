...
typedef struct TAG_sReadAlignLoci {
	...
	UINT16  FlagCA:1;			// set if this hit has been determined as being correctly aligned (original loci known as read was generated by kit4b)
	UINT16  FlagIA:1;			// set if this hit has been determined as being incorrectly aligned (original loci known as read was generated by kit4b)
...
typedef struct TAG_sReadHitLoci {
	...
	UINT8  FlagCA:1;			// set if this hit has been determined as being correctly aligned (original loci known as read was generated by kit4b)
	UINT8  FlagIA:1;			// set if this hit has been determined as being incorrectly aligned (original loci known as read was generated by kit4b)
