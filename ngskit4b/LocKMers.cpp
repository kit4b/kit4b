...
NumAcceptedExtdKMers = GetKMerProcProgress(&NumBlocks,&NumKMers,&NumPutativeKMers, &NumAcceptedKMers);
gDiagnostics.DiagOut(eDLInfo,gszProcName,"Completed - K-Mers processed: %zd, Cultivar specific : %u, Hamming retained: %u, Accepted: %u",NumKMers,NumPutativeKMers, NumAcceptedKMers,NumAcceptedExtdKMers);
