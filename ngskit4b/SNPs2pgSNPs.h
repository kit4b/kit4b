...
const int cAlignNumSSNPfields = 23;			// if generated by 'kit4b align' then there will be this many CSV fields
...
class CSNPs2pgSNPs
{
	...
	char m_szOutSiteDistFile[_MAX_PATH];		// SNP site distributions writeen to this file	
	...
	int m_hOutSiteDist;							// output SNP site distributions handle
