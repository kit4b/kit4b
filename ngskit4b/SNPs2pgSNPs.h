...
const int cAllocNumIsolateFeatSNPs = 10000;	// initially allocate for this number of isolate feature SNPs

const int cMaxChromNames = 10000;			// can only handle a max of this many chromosome names - memory is statically allocated
const int cMaxReadsetNames = 10000;			// can only handle a max of this many readset names - memory is statically allocated
