...
# ngskit4bs
g++  -static -g -O2 -Wl,-z,stack-size=0x01ffffff -o ngskit4bs KAlignerCL.o Blitz.o genDESeq.o kit4bax.o LocKMers.o mergeoverlaps.o Scaffolder.o SQLiteSummaries.o \
